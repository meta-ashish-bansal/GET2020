...
public class SignInServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse responce) throws IOException{
		...
		try {
			Connection con = sqlConnection.sqlConnect("ParkingSystem", "root", "root");
			...
			if(!result.next()){
				...
				out.println("<a href=\"../../../Assignment4/SignIn.jsp\"><div class=\"innerBox\"><h1>Sign In</h1></div></a>");
				out.println("<a href=\"../../../Assignment4/EmployeeRegistration.jsp\"><div class=\"innerBox\"><h1>Sign Up</h1></div></a></div>");
			}
			else{
				...
				out.println("<a href=\"../../../Assignment4/SelectPass.jsp\"><div class=\"innerBox\"><h1>Select Plan</h1></div></a>");
				out.println("<a href=\"../../../Assignment4/HomePage.jsp\"><div class=\"innerBox\"><h1>Home<br> Page</h1></div></a></div>");
			}
			out.println("</div>");
			out.println("</body>");
			out.println("</html>");
